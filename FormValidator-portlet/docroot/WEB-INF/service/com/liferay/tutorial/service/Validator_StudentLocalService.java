...
/**
 * Provides the local service interface for Validator_Student. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author annv
 * @see Validator_StudentLocalServiceUtil
...
public interface Validator_StudentLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Validator_StudentLocalServiceUtil} to access the validator_ student local service. Add custom service methods to {@link com.liferay.tutorial.service.impl.Validator_StudentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
