...
/**
 * Provides the local service interface for Validate_St. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author annv
 * @see Validate_StLocalServiceUtil
...
public interface Validate_StLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Validate_StLocalServiceUtil} to access the validate_ st local service. Add custom service methods to {@link com.liferay.tutorial.service.impl.Validate_StLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
