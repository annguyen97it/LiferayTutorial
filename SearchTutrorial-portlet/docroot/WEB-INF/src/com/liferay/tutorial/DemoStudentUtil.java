...
import com.liferay.tutorial.search.StudentSearchContainer;
import com.liferay.tutorial.search.StudentSearchTerms;
...
public class DemoStudentUtil {
	...
	private static void initData() {
		...
		if (students == null || students.size() == 0) {
			...
			students.add(new Student("SV001", "Nguyen Van An", new Date(), true, "Ha Tinh"));
